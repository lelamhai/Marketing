...
<html lang="en">
   ...
   <body>
      ...
      <div class="siteWrapper">
         <div class="page-top">
            <img src="<?php echo get_bloginfo("template_directory"); ?>/assets/imgs/icon/icon_top.png">
         </div>
                        ...
                        <div class="headerContainer">
                           <header class="headerContent">
                              <h1 class="logo"><a href="#" itemprop="url">
                                 <img src="<?php echo get_bloginfo("template_directory"); ?>/assets/imgs/logo.png" alt="Marketing 360®" title="Marketing 360®"></a>
                              </h1>
